...
public class AddrbookFriendAdapter extends BaseAdapter implements SectionIndexer {
    private List<User> list = null;
    private Context mContext;

    public AddrbookFriendAdapter(Context mContext, List<User> list) {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.addrbook_friend_item, null);
            viewHolder.ivHead = (ImageView) view.findViewById(R.id.addrbook_friend_item_head_iv);
            viewHolder.tvTitle = (TextView) view.findViewById(R.id.addrbook_friend_item_title_tv);
            viewHolder.tvLetter = (TextView) view.findViewById(R.id.addrbook_friend_item_catalog_tv);
            viewHolder.tvCopyPosition = (TextView) view.findViewById(R.id.addrbook_friend_item_copyposition_tv);
