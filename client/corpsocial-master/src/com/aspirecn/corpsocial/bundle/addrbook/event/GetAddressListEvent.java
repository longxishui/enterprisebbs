 ...
 */
public class GetAddressListEvent extends BusEvent {
    ...
    public GetAddressListEvent() {
    }
    public GetAddressListEvent(int start, int limit, List<CorpModified> lastModifiedList) {
        this.start = start;
        this.limit = limit;
