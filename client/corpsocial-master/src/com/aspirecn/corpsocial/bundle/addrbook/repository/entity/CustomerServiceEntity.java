...
public class CustomerServiceEntity {
    ...
    private CustomerServiceEntity(Builder build) {
        this.id = build.id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        CustomerServiceEntity other = (CustomerServiceEntity) obj;
        if (id == null) {
            if (other.id != null)
                return false;
    ...
    public static class Builder {
        ...
        public CustomerServiceEntity build() {
            return new CustomerServiceEntity(this);
        }
