 ...
 * @author chenziqiang
 */
public class AddrbookGroupAdapter extends BaseAdapter {

    private List<Group> list = new ArrayList<Group>();
    private ViewHolder holder = null;
    private Context context;

    public AddrbookGroupAdapter(Context context, List<Group> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup arg2) {
        ...
        // 头像
        if (list.get(position).getGroupType() == 0) {// 自建群
