 ...
 * @author lihaiqiang
 */
@UIEventHandler(eventType = CancelMoveChatToTopEvent.class)
public class CancelMoveChatToTopEventHandler implements
        IHandler<Null, CancelMoveChatToTopEvent> {
    ...
    @Override
    public Null handle(CancelMoveChatToTopEvent busEvent) {
        ...
        if (chatEntity != null) {
            chatEntity.setMoveToTopTime(null);
